...
from subiquity.models.storage import raidlevels_by_value
from subiquity.ui.views.storage.raid import RaidStretchy
from subiquity.ui.views.storage.tests.test_partition import make_model_and_disk
...
class RaidViewTests(unittest.TestCase):
    def test_create_raid(self):
        ...
        view.controller.raid_handler.assert_called_once_with(None, expected_data)
    ...
    def test_edit_raid(self):
        ...
        view_helpers.enter_data(stretchy.form, form_data)
        view_helpers.click(stretchy.form.done_btn.base_widget)
        view.controller.raid_handler.assert_called_once_with(raid, expected_data)
