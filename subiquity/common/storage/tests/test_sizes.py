...
from subiquity.common.storage.sizes import (
...
from subiquity.models.storage import MiB
...
class TestCalculateInstallMin(unittest.TestCase):
    @mock.patch("subiquity.common.storage.sizes.uefi_scale")
    @mock.patch("subiquity.common.storage.sizes.bootfs_scale")
