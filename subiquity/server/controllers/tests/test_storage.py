...
class TestCoreBootInstallMethods(IsolatedAsyncioTestCase):
    ...
    async def test_guided_core_boot(self, va_input, va_expected):
        ...
        if va_expected is None:
            self.assertIsNone(self.ctrler.core_boot_plan.volumes_auth)
        else:
            self.assertEqual(va_expected, self.ctrler.core_boot_plan.volumes_auth)
    ...
    async def test_from_sample_data(self):
        ...
        installer = CoreBootInstaller(self.app, self.ctrler.core_boot_plan)
