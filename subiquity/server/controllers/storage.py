...
from subiquity.server.snapd.core_boot_installer import CoreBootInstallPlan
...
class StorageController(SubiquityController, StorageManipulator):
    ...
    def __init__(self, app) -> None:
        ...
        self.core_boot_plan: Optional[CoreBootInstallPlan] = None
    ...
    def use_snapd_install_api(self):
        return self.core_boot_plan is not None
    ...
    async def guided_core_boot(self, disk: ModelDisk, choice: GuidedChoiceV2):
        ...
        self.core_boot_plan = CoreBootInstallPlan(
            info=self._info,
            on_volume=on_volume,
