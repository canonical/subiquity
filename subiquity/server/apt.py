...
async def configure_apt(app, context):
    ...
    config = {
        'apt': app.base_model.mirror.config
        }
    config_location = os.path.join(
        app.root, 'var/log/installer/subiquity-curtin-apt.conf')
    ...
    app.note_data_for_apport("CurtinAptConfig", config_location)
