...
* **default:** default groups, as defined by the target system

Configures which groups the newly created user should belong to. The default groups defined by the target system can either be included or excluded.
...
Specifies the list of groups that the user should belong to, instead of the defaults.
...
.. code-block:: yaml
    ...
    autoinstall:
      identity:
        ...
        password: '$6$wdAcoXrU039hKYPd$508Qvbe7ObUnxoj15DRCkzC3qO7edjH0VV7BPNRDYK4QR8ofJaEEF2heacn0QgD.f8pO8SNp83XNdWG6tocBM1'
        hostname: ubuntu
        # Specifies the exact list of groups the user should belong to.
    ...
    autoinstall:
      identity:
        ...
        password: '$6$wdAcoXrU039hKYPd$508Qvbe7ObUnxoj15DRCkzC3qO7edjH0VV7BPNRDYK4QR8ofJaEEF2heacn0QgD.f8pO8SNp83XNdWG6tocBM1'
        hostname: ubuntu
        # Ensure the user is part of extra groups.
        groups:
